...
var Assunto,sDestinatario: String;
begin
  GeraXML;
...
begin
  ...
  CdsClientes.Filter := 'UPPER('+CBCampos.Text+') Like ' +UpperCase(QuotedStr('%' + EditConsulta.Text + '%'));
...
begin
  ...
  begin
   ...
   begin
    ...
    Else
    ShowMessage('Infelizmente Não é Possível Enviar o Email Porquê Você Não Está Conectado'+
    ' à Internet.')
    end;
...
if not (MaskEditCep.Text = '     -   ') then
 ...
 PreencheEndereco;
  ...
  ShowMessage('Infelizmente Não é Possível Buscar as Informações do Endereço Porquê Você Não Está Conectado'+
    ' à Internet.'+#10+'Preencha os Campos Manualmente')
end;
